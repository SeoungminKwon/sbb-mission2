package com.example.sbbmission2.answer;

import com.example.sbbmission2.DataNotFoundException;
import com.example.sbbmission2.question.Question;
import com.example.sbbmission2.question.QuestionService;
import com.example.sbbmission2.user.SiteUser;
import com.example.sbbmission2.user.UserService;
...
public class AnswerController {
    ...
    public String answerModify(@Valid AnswerForm answerForm, BindingResult bindingResult, @PathVariable("id") Integer id, Principal principal) {
        ...
        Answer answer = this.answerService.getAnswer(id);
        if (!answer.getAuthor().getUsername().equals(principal.getName())) {
            throw new DataNotFoundException("수정권한이 없습니다.");
        }
